...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void getValues() {
        ...
        String cream = spnCream.getSelectedItem().toString();
        String sugar = spnSugar.getSelectedItem().toString();

        output = "Hey " + name + " Thank you for your order of " + coffee + cream + sugar +
                " with " + addOn;
