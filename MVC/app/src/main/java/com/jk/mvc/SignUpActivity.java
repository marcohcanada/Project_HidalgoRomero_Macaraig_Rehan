...
public class SignUpActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        switch (v.getId()){
            case R.id.btn_submit:
                ...
                if (this.validateData()) {
                    ...
                    newUser = new User(firstName, lastName, phoneNumber, gender, email, password);
    ...
    private boolean validateData() {
        ...
        if (edtFname.getText().toString().isEmpty()) {
            edtFname.setError("You must enter a first name");
            allValidations = false;
        }

        if (edtLname.getText().toString().isEmpty()) {
            edtLname.setError("You must enter a last name");
            allValidations = false;
        }

        if (edtPhone.getText().toString().isEmpty()) {
            edtPhone.setError("You must enter a phone number");
            allValidations = false;
        }

        if (edtEmail.getText().toString().isEmpty()) {
            edtEmail.setError("You must enter am email address");
            allValidations = false;
        ...
        if (edtPswd.getText().toString().isEmpty()) {
            edtPswd.setError("You must enter a password");
            allValidations = false;
        }

        if (edtConfirm.getText().toString().isEmpty()) {
            edtConfirm.setError("You must re-enter the password");
            allValidations = false;
